...
# Sample Information
if (file.exists(sample_info_param)) {
...
######################################### THIS ISNT WORKING FOR SOME REASON FOR SAMPLE_ID
...
####################################
string_info_sample <- get_sample_info(sample_of_interest)
...
##################################
tech_spec_text <- paste("**Signature Database**", "\n", "\n", sig_description, "\n", "\n",
  "**Fitting Method**", "\n", "\n", "Sigminer QP",
  sep = "\n"
)

tech_spec_card_init <- card(
  div(class = "card-details",
      p(class = "text-body", markdown(tech_spec_text))),
)
