...
cleanEx()
nameEx("generate_single_report")
### * generate_single_report

flush(stderr()); flush(stdout())

### Name: generate_single_report
### Title: A Capitalized Title (ideally limited to 65 characters)
### Aliases: generate_single_report
...
cleanEx()
nameEx("generate_summary_layer")
### * generate_summary_layer

flush(stderr()); flush(stdout())

### Name: generate_summary_layer
### Title: A Capitalized Title (ideally limited to 65 characters)
### Aliases: generate_summary_layer
