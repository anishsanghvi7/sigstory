...
document_link <- glue('<a href="https://github.com/anishsanghvi7/sigstory?tab=readme-ov-file\\#full-report-generation" target="_blank">Full Report Generation Documentation</a>')
...
if (total_mutations > 0 && length(good_sigs) != 0) {
    if (nrow(parquet_db) != 0) {
      ...
      card(
        ...
        markdown(glue("NOTE: Parquet Path not inputted. To pass through a parquet database refer to the ", document_link))
      )
    }
